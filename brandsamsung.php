...
<html lang="en">
	...
	<?php    
                        ...
                        require 'db.php';
                        $title="SAMSUNG";
                        $aff=mysqli_query($connect,"SELECT * FROM product where marque LIKE '$title'");
	...
	<div class="add-to-cart">
							...
							<button class="add-to-cart-btn" > <a href="sign in.php"> <i class="fa fa-info" aria-hidden="true"></i>
							Info </a>
