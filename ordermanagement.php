...
<head>
    ...
    <style> 
             .btn {border: white;font-size: 15px; display: inline-block;padding: 6px 12px;margin-bottom: 0;
              ...
              td, th {border: 1px solid #dddddd;text-align: center;padding: 1px;}
...
<div class="sidebar">
  ...
  <?php   
   ...
   $aff=mysqli_query($connect,"SELECT * FROM  `order-info` WHERE statut='Wait' ");
...
<form action="checkorder.php" method="POST" class="td">
<table>
...
<tr>
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="id"  placeholder="Id" required>
  </div>        </th>

    
    <th>    <div class="mb-3" >
  
  <input class="form-control"  id="formFile" name="donee"  placeholder="Done"  required>
</div>   </th>


<th>    <button type="submit" class="btn btn-primary"  name="done">   Done</button>     </th>
...
<form  method="get" >
  ...
  <tr>
    <th> <div class="header-search">
      
    <input class="input" placeholder="Search here Id" name="text">
...
<?php  
                   ...
                   if(isset($_GET['submit'])){
                            ...
                            $title= $_GET['text'];
                            $aff= "SELECT * FROM product WHERE reference LIKE '$title'";
