...
<div class="mb-3" >
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="marque" required>
  </div>
...
if(isset($_POST['upd'])){
  ...
  $up=  " UPDATE product set img='$img',img1='$img1',img2='$img2',img3='$img3', name='$name', marque='$marque',  price='$price', new='$new', category='$category', description='$description'
